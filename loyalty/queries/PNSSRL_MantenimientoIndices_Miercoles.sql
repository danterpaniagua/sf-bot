-- Job:      PNSSRL_MantenimientoIndices_Miercoles
-- Database: PNSSRL / msdb
-- Status:   DISABLED (last run: 2024-05-30)

-- ============================================================
-- Step 1: Index maintenance — Wednesday modules only
-- ============================================================
USE PNSSRL
GO

DECLARE @base      VARCHAR(100) = NULL
DECLARE @modulo    VARCHAR(100) = 'MIERCOLES'
